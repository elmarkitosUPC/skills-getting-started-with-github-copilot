...
activities = {
    ...
    "Basketball Club": {
        "description": "Improve shooting, passing, and defensive skills in a competitive environment",
        "schedule": "Mondays and Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["noah@mergington.edu", "liam@mergington.edu"]
    },
    "Drama Club": {
        "description": "Explore acting, stage performance, and dramatic storytelling techniques",
